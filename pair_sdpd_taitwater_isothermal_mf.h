...
class PairSDPDTaitwaterIsothermalMf: public Pair {
 ...
 protected:
  ...
  //Modified by ASE, adding new variables for parameters ra, rb, A and F_int models (F) from Tartakovsky. Also a g_d for gamma_dot target in walls (for thixo model particularly)
  double temperature, pb, rhoeq, ra, rb, A, g_d, fluid_type;
  int F;
  
  //Modified by ASE, adding new variables wall_index, a, b, alpha, f0, tau and m for thixotropic model
  double **wall_index, **a_thixo, **b_thixo, **alpha_thixo, **f0_thixo, **tau_thixo, **m_thixo ;
